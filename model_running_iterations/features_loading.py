...
def phecodes_and_notesCounts(label, agg_mode):
    df_conditions = pd.read_csv("../exported_data/timestamp_filter/df_conditions_phencode.csv")
    df_cohort =  pd.read_csv("../exported_data/timestamp_filter/df_demographics_updated_label.csv")
    df_notes_counts = pd.read_csv("../exported_data/timestamp_filter/df_note_counts.csv")
    demographics_cols = ["new_age", "race_source_value", "gender_source_value", label, "person_id"]
    df_cohort_v1 = df_cohort[demographics_cols].copy()
...
def hpo_ONLY(label, agg_mode):
    df_conditions = pd.read_csv("../exported_data/timestamp_filter/df_conditions_hpo.csv")
    df_cohort =  pd.read_csv("../exported_data/timestamp_filter/df_demographics_updated_label.csv")
    demographics_cols = ["new_age", "race_source_value", "gender_source_value", label, "person_id"]
    df_cohort_v1 = df_cohort[demographics_cols].copy()
    
    preprocessor = data_preprocessing.preprocessing()
    new_condition_df = preprocessor.calc_frequency(df_conditions, "condition_start_date", "omop_name")
...
def notes_conditions_ONLY(label, agg_mode):
    df_conditions_notes = pd.read_csv("../exported_data/timestamp_filter/notes_extracted_concepts_final.csv")
    df_cohort =  pd.read_csv("../exported_data/timestamp_filter/df_demographics_updated_label.csv")
    df_notesCounts = pd.read_csv("../exported_data/timestamp_filter/df_note_counts.csv")
    demographics_cols = ["new_age", "race_source_value", "gender_source_value", label, "person_id"]
    df_cohort_v1 = df_cohort[demographics_cols].copy()
...
def notes_structures_conditions(label, agg_mode):
    df_conditions_notes = pd.read_csv("../exported_data/timestamp_filter/notes_extracted_concepts_final.csv")
    df_conditions_structure = pd.read_csv("../exported_data/timestamp_filter/df_conditions_phencode.csv")
